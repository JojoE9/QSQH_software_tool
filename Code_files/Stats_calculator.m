...
File3D_vel_name = 'u_plus_qsqh_loop_005_test.mat';
...
plot(Dx_qsqh_ref,Rux_qsqh_ref,'LineStyle','--','Marker','none', ...
    'MarkerIndices',1:10:length(Dx_qsqh_ref),'LineWidth',1, ...
    'Color','k','DisplayName', ...
    'Reference Ouput')
...
plot(Dz_qsqh,Ruz_qsqh,'LineStyle','-','Marker','none', ...
    'MarkerIndices',1:10:length(Dz_qsqh),'LineWidth',1, ...
    'Color','k','DisplayName', ...
    'User Generated Ouput')
...
plot(Dz_qsqh_ref,Ruz_qsqh_ref,'LineStyle','--','Marker','none', ...
    'MarkerIndices',1:10:length(Dz_qsqh_ref),'LineWidth',1, ...
    'Color','k','DisplayName', ...
    'Reference Ouput')
